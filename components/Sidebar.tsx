...
export const Sidebar: React.FC<SidebarProps> = ({ currentView, onNavigate, user, onLogout }) => {
  const navItems = [
    ...
    { id: View.MANUAL, label: 'Manual', icon: 'M9.663 17h4.673M12 3v1' },
    { id: View.ORBIT, label: 'Orbit', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z' },
    { id: View.LIVE_VOICE, label: 'Live', icon: 'M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4' },
    { id: View.INTELLIGENCE, label: 'API', icon: 'M21 21l-6-6' },
    { id: View.IMAGE_STUDIO, label: 'Assets', icon: 'M4 16l4.586-4.586a2 2 0 012.828 0L16 16' },
    { id: View.SAFE_PLACE, label: 'Idle', icon: 'M4.318 6.318a4.5 4.5 0 000 6.364' },
  ];
